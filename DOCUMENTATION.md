...
Autopsy uses [Bootstrap 4](v4-alpha.getbootstrap.com) as a CSS framework and flexbox for a responsive layout. However, the Autopsy window has a minimum width and height, and there is no mobile version of the site.
